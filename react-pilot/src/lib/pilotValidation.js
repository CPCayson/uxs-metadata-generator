...
export function defaultPilotState() {
  return {
    ...
    distribution: {
      ...
      nceiMetadataContactHref: 'https://data.noaa.gov/docucomp/440b3ac2-64a5-46e2-9846-38305718b644',
      nceiMetadataContactTitle: 'NCEI (pointOfContact)',
      nceiDistributorContactHref: 'https://data.noaa.gov/docucomp/440b3ac2-64a5-46e2-9846-38305718b644',
      nceiDistributorContactTitle: 'NCEI (distributor)',
